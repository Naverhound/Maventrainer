...
<head>
    ...
    <!-- favicon
		============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('/dash/img/favicon.ico')}}">
    <!-- Google Fonts
		============================================ -->
	...
	<!-- nalika Icon CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('/dash/css/nalika-icon.css')}}">
    <!-- owl.carousel CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('/dash/css/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{asset('/dash/css/owl.theme.css')}}">
    <link rel="stylesheet" href="{{asset('/dash/css/owl.transitions.css')}}">
    <!-- animate CSS
		============================================ -->
    ...
    <!-- meanmenu icon CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('/dash/css/meanmenu.min.css')}}">
    <!-- main CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('/dash/css/main.css')}}">
    <!-- morrisjs CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('/dash/css/morrisjs/morris.css')}}">
    <!-- mCustomScrollbar CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('/dash/css/scrollbar/jquery.mCustomScrollbar.min.css')}}">
    <!-- metisMenu CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('/dash/css/metisMenu/metisMenu.min.css')}}">
    <link rel="stylesheet" href="{{asset('/dash/css/metisMenu/metisMenu-vertical.css')}}">
    <!-- calendar CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('/dash/css/calendar/fullcalendar.min.css')}}">
    <link rel="stylesheet" href="{{asset('/dash/css/calendar/fullcalendar.print.min.css')}}">
    <!-- style CSS
		============================================ -->
    ...
    <!-- modernizr JS
		============================================ -->
    <script src="{{asset('/dash/js/vendor/modernizr-2.8.3.min.js')}}"></script>
</head>
...
<body>
   ...
   <!--sidebar-->
    ...
    <!-- price-slider JS
		============================================ -->
    <script src="{{asset('/dash/js/jquery-price-slider.js')}}"></script>
    <!-- meanmenu JS
		============================================ -->
    <script src="{{asset('/dash/js/jquery.meanmenu.js')}}"></script>
    <!-- owl.carousel JS
		============================================ -->
    <script src="{{asset('/dash/js/owl.carousel.min.js')}}"></script>
    <!-- sticky JS
		============================================ -->
    <script src="{{asset('/dash/js/jquery.sticky.js')}}"></script>
    <!-- scrollUp JS
		============================================ -->
    <script src="{{asset('/dash/js/jquery.scrollUp.min.js')}}"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    <script src="{{asset('/dash/js/scrollbar/jquery.mCustomScrollbar.concat.min.js')}}"></script>
    <script src="{{asset('/dash/js/scrollbar/mCustomScrollbar-active.js')}}"></script>
    <!-- metisMenu JS
		============================================ -->
    <script src="{{asset('/dash/js/metisMenu/metisMenu.min.js')}}"></script>
    <script src="{{asset('/dash/js/metisMenu/metisMenu-active.js')}}"></script>
    <!-- sparkline JS
		============================================ -->
    <script src="{{asset('/dash/js/sparkline/jquery.sparkline.min.js')}}"></script>
    <script src="{{asset('/dash/js/sparkline/jquery.charts-sparkline.js')}}"></script>
    <!-- calendar JS
		============================================ -->
    <script src="{{asset('/dash/js/calendar/moment.min.js')}}"></script>
    <script src="{{asset('/dash/js/calendar/fullcalendar.min.js')}}"></script>
    <script src="{{asset('/dash/js/calendar/fullcalendar-active.js')}}"></script>
	<!-- float JS
		============================================ -->
    <script src="{{asset('/dash/js/flot/jquery.flot.js')}}"></script>
    <script src="{{asset('/dash/js/flot/jquery.flot.resize.js')}}"></script>
    <script src="{{asset('/dash/js/flot/curvedLines.js')}}"></script>
    <script src="{{asset('/dash/js/flot/flot-active.js')}}"></script>
    <!-- plugins JS
		============================================ -->
